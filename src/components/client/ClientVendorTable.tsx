              ...
              >
                          ...
                          <span
                            ...
                            className={
                              closed
                                ...
                                : "inline-flex items-center gap-1 rounded-full border border-[var(--terracotta)]/30 bg-[var(--terracotta)]/10 px-2 py-0.5 text-[10px] font-medium text-[var(--terracotta)]"
                            }
                          >
                ...
                <Td>
                  {v.google_rating != null ? (
                    <span className="inline-flex items-center gap-1 text-[var(--charcoal)]/85">
