      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        ...
        >
          ...
          <button
            ...
            className={`inline-flex items-center gap-1.5 border-l border-[var(--border)] px-3 py-1.5 ${
              sub === "table"
                ? "bg-[var(--charcoal)] text-[var(--cream)]"
                : "text-[var(--charcoal)]/65 hover:bg-[var(--cream)]"
            }`}
...
function CategoryRow({
  ...
  return (
    <div
      ...
      className="rounded-lg border border-[var(--border)] bg-white p-3 transition-shadow hover:shadow-sm"
